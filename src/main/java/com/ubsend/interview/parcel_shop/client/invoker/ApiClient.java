package com.ubsend.interview.parcel_shop.client.invoker;
...
import com.ubsend.interview.parcel_shop.client.invoker.auth.ApiKeyAuth;
import com.ubsend.interview.parcel_shop.client.invoker.auth.Authentication;
import com.ubsend.interview.parcel_shop.client.invoker.auth.HttpBasicAuth;
import com.ubsend.interview.parcel_shop.client.invoker.auth.OAuth;

@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2021-03-06T15:12:17.756+01:00")
@Component("com.ubsend.pss.client.invoker.ApiClient")
public class ApiClient {
	...
	private String basePath = "https://staging-api.ubsend.io/v1/parcel-shops";
	...
	/**
	 * Select the Content-Type header's value from the given array: if JSON exists in the given array, use it; otherwise use the first one
	 * of the array.
	 *
